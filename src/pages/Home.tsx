    ...
    >
      <div className="flex flex-col md:flex-row gap-12 items-center md:items-start mt-10">
        ...
        <motion.div variants={itemVariants} className="flex-1 space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-sm font-mono text-primary">
            <Terminal size={14} />
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl font-mono leading-relaxed">
        ...
        <motion.div variants={itemVariants} className="hidden md:flex flex-1 justify-end">
          <div className="w-80 h-80 rounded-2xl bg-gradient-to-br from-dark-800 to-dark-900 border border-white/10 shadow-2xl overflow-hidden relative">
            ...
            <div className="p-6 pt-12 font-mono text-sm text-slate-400 leading-loose">
